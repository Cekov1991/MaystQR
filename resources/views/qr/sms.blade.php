...
@section('title', 'Send SMS - {{ $qrCode->name }}')
@section('description', 'Send an SMS message')
            ...
            <div class="col-lg-8 col-md-10">
                <div class="card shadow-lg border-0">
                    <div class="card-body text-center p-5">
                        ...
                        <!-- Main Message -->
                        <h1 class="h2 text-primary mb-3">Send SMS</h1>
                        <p class="text-muted mb-4">Click the button below to open your messaging app</p>
                        ...
                        <div class="mt-4">
                            <a href="{{ $qrCode->formated_content }}" class="btn btn-primary btn-lg">
                                <i class="bi bi-chat-dots me-2"></i>Open Messaging App
                            </a>
                        </div>
