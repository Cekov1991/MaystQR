...
@section('title', 'Message — ' . $qrCode->name)
@section('description', 'Send a text message')
...
@section('content')
    ...
    <div class="eq-scan">
        <div class="eq-scan-head">
            <p class="eq-scan-eyebrow">Text message</p>
            <h1 class="eq-scan-title">{{ $phone }}</h1>
            <p class="eq-scan-note">Opens your messaging app with the message ready to send.</p>
        </div>
        ...
        <div class="eq-card">
            ...
            <div class="eq-scan-actions">
                <a href="{{ $qrCode->formated_content }}" class="eq-btn eq-btn-primary">Send this message</a>
