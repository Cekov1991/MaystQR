                                            ...
                                            @foreach ($packages as $package)
                                                <div class="col-md-6 col-lg-4 mb-3">
                                                    <div class="package-option">
                                                        <div class="pricing-card h-100 {{ $package->id == 2 ? 'selected' : '' }}">
                                                            @if ($package->id == 2)
                                                            ...
                                                            <div class="text-center">
                                                                ...
                                                                <a class="btn btn-outline-primary"
                                                                    data-paddle-price-id="{{ $package->paddle_price_id ?? 'pri_01k1tx61073h2qd88c2h97q4ad'}}"
                                                                    data-package-id="{{ $package->id }}"
                                                                    data-qr-code-id="{{ $qrCode->id }}"
                                                                    >
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        Paddle.Initialize({
            token: "test_b09344cce504062fd7fd7432efa" // replace with a client-side token
        });

        document.querySelectorAll('a').forEach(a => {
            a.addEventListener('click', openCheckout);
        });

        function openCheckout(items) {
            const paddlePriceId = this.getAttribute('data-paddle-price-id');
            const qrCodeId = this.getAttribute('data-qr-code-id');
